      ...
      <div class="col-9">
        <div class="card card-primary">
          <div class="card-header">
            <h4 class="card-title">
              <h1 class="m-0"><span class="badge badge-light">Hasta Yakını Değerlendirme Formu</h1></span></h1>
            </h4>
          </div>
          <form action="sayfalar/anketekle/insert.php" method="POST">
            ...
            <div class="card-footer">
              <nav id="mainav" class="fl_right">
                ...
                <input style="margin: 5px" type="submit" class="btn btn-block btn-primary" name="insert6" value="Gönder">
              </nav>
            </div>
          </form>
        </div>
